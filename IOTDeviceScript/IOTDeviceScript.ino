...
const char ssid[] = "OSCARBV_2.4GHZ ETB"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = ".wifi.23"; // TODO cambiar por la contraseña de la red WiFi

//Conexión a Mosquitto
#define USER "obuitrago" // TODO Reemplace UsuarioMQTT por un usuario (no administrador) que haya creado en la configuración del bróker de MQTT.
const char MQTT_HOST[] = "52.204.130.236"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
const int MQTT_PORT = 8082;
const char MQTT_USER[] = USER;
//Contraseña de MQTT
const char MQTT_PASS[] = "obuitrago"; // TODO Reemplace ContrasenaMQTT por la contraseña correpondiente al usuario especificado.

//Tópico al que se recibirán los datos
// El tópico de publicación debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/out
const char MQTT_TOPIC_PUB[] = "colombia/cundinamarca/cajica/" USER "/out"; //TODO Reemplace el valor por el tópico de publicación que le corresponde.
// El tópico de suscripción debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/in
const char MQTT_TOPIC_SUB[] = "colombia/cundinamarca/cajica/" USER "/in"; //TODO Reemplace el valor por el tópico de suscripción que le corresponde.
