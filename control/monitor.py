...
def analyze_lux():
    # Consulta los datos de los últimos 5 minutos para la medida de luminosidad
    # Compara el promedio con los valores con los límites que están en la base de datos para esa variable.
    # Si el promedio se excede de los límites, se envía un mensaje para los actuadores.
...
def start_cron():
    ...
    schedule.every(10).seconds.do(analyze_lux)
